    ...
    @method('PATCH')
                <div class="form-group column">
                    ...
                    <div class="col-sm-1-12">
                        <input type="text" class="form-control" name="Name" id="Name" value="{{$shawl->Name}}">
                    </div>
                </div>
                <div class="form-group column">
                    <label for="Brand" class="col-sm-1-12 col-form-label"><h5>Brand: </h5></label>
                    <div class="col-sm-1-12">
                        <input type="text" class="form-control" name="Brand" id="Brand" value="{{$shawl->Brand}}">
                    </div>
                </div>
                <div class="form-group column">
                    <label for="Price" class="col-sm-1-12 col-form-label"><h5>Price: </h5></label>
                    <div class="col-sm-1-12">
                        <input type="text" class="form-control" name="Price" id="Price" value="{{$shawl->Price}}">
                    </div>
                </div>
                <div class="form-group column">
                    <label for="Quantity" class="col-sm-1-12 col-form-label"><h5>Quantity: </h5></label>
                    <div class="col-sm-1-12">
                        <input type="text" class="form-control" name="Quantity" id="Quantity" value="{{$shawl->Quantity}}">
                    </div>
                </div>
                <div class="form-group column">
                    <label for="created_at" class="col-sm-1-12 col-form-label"><h5>Updated Date: </h5></label>
                    <div class="col-sm-1-12">
                        <input type="date" class="form-control" name="created_at" id="created_at" value="{{$shawl->updated_at}}">
                    </div>
                </div>
